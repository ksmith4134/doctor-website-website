...
import profilePic from "../../../../public/holofoil/profilePic.png";
import foreground from "../../../../public/holofoil/foreground-29.png";
                        ...
                        <div className='flex flex-col justify-between items-center text-gray-200'>
                            ...
                            <div className='flex flex-col justify-center items-center mb-20'>
                                ...
                                <div className='mt-8 -mb-4'>
                                    ...
                                    <h5 className='text-center mt-1 text-sm font-light'>
                                        Attending Physician
                                    </h5>
