...
export default function Card(props) {
    ...
    return (
        <div className={`p-px rounded-4xl ${BACKGROUND.GRADIENT_DIRECTION[backgroundGradient]} from-white/10 from-0% to-white/5 to-50% overflow-hidden`}>
            <div className="relative w-full h-full rounded-4xl bg-gray-950">
                <div className="w-full h-full rounded-4xl overflow-hidden bg-noise bg-repeat">
                    <div className={`w-full h-full px-12 py-14 rounded-4xl ${BACKGROUND.GRADIENT_DIRECTION[backgroundGradient]} from-[#565A67]/20 to-transparent shadow-inner shadow-gray-600/5`}>
