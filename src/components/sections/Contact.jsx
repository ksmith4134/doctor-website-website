    ...
    return (
        <div className='rounded-3xl border border-gray-600/20 bg-gray-600/5 overflow-hidden'>
            <div className={`w-full h-full bg-noise bg-repeat`}>
                <div className="p-2 flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-20 bg-custom-gradient-1">

                    {/* TESTIMONIAL */}
                    <div className='basis-7/12 p-8 lg:p-16 flex flex-col items-center gap-8'>
                        <h3 className='pt-4 lg:pt-0 text-2xl font-hind font-semibold text-gray-200 text-center'>
                            Thank you Revere!
                        </h3>
                    ...
                    {/* CONTACT FORM */}
                    <div className='basis-5/12 shrink-0 rounded-2xl backdrop-blur-[64px] bg-white/5 border border-white/5 overflow-hidden'>
