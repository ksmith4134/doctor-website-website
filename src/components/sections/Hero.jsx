...
export default function Hero() {
    return (
        <div className="max-w-6xl mx-auto pt-20 bg-gradient-radial from-white/5 to-transparent to-[70%]">
            <div className="flex justify-between items-center gap-8">
                <div className="basis-[60%]">
                    ...
                    <h2 className="mt-8 text-md text-gray-200 leading-relaxed text-balance">Our services were designed from the ground up to meet the specific needs of healthcare organizations, from small private practices to large hospitals.</h2>
